...
const Hero = () => {
  return (
    <div className='relative min-h-screen'>
        <Image className='lg:w-[580px] h-auto absolute right-0 top-0 -z-10' src='/hero2.png' width={1000} height={600} alt='hero bg' />
        ...
        <div className='container h-[clac(100vh-120px)] grid items-center'>
          <div className='space-y-4 bg-[#ffffff98] w-fit p-4'>
            ...
            <h2 className='text-4xl sm:text-6xl font-bold'>
              ...
              <p className='text-gray-700 text-[14px smm:text-[16px]'>
